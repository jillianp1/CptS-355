...
class HW4Part2Tests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.opstack_output= {
            ...
            'test34': [15],
            'test35': [3],
            'test36': [StrConstant('(Hello 100ld)'), 49],
            'test37': [StrConstant('(Hello world)'), False, True]}
    ...
    # Need to make 5 additional tests: 
    ...
    def test_input36(self):
        testinput36 = """
        (Hello world) dup 6 (100) putinterval
        dup 6 get
        """
